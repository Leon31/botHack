var arrOfQuest = [
  ...
  { quest: 'Which of these is a correct method to create a new array?',
    ...
    payload: [ "false Reference/Global_Objects/Array", "true", "false Reference/Global_Objects/Array" ] },
  ...
  { quest: 'What does the following expression return? 1 + 5 + ” bottles of milk”;',
    title:
     [ '“15 bottles of milk”',
       '“6 bottles of milk”',
       '“5 bottles of milk”' ],
    payload: [ "false Reference/Global_Objects/String", "true", "false Reference/Global_Objects/String" ] },
  { quest: 'What is the result of the following statement: typeof “x”;',
    title:
     [ '“character”',
       ...
       '“string”',
       '“undefined”' ],
    payload: [ "false Reference/Operators/typeof", "false Reference/Operators/typeof", "true", "false Reference/Operators/typeof" ] },
